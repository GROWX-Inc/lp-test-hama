/* gMeas: 計測dataLayer標準実装 v1 億万鳥者版（2026/08/31）
   KAMAKURA gMeas v1（GROWX計測標準）準拠。差分は次の2点のみ：
   ...
   排他ルール：予約リンク=cta_clickのみ／#hdCta・#dwGr=review_badge_clickのみ（outbound_clickは出さない）
...
(function(){
  try{
    ...
    document.addEventListener("click",function(e){
      try{
        ...
        if(id==="hdCta"||id==="dwGr"){
          ...
          push(base({event:"review_badge_click"}));
    ...
    var MARKS={
      top:    [{sel:"#concept",id:"concept"},{sel:"#menu",id:"menu"},{sel:"#review",id:"review"},{sel:"#access",id:"access"}],
